...
```bash
    > git clone https://github.com/EkMi00/AI-Fraud-Ext.git
    # now be in the gama folder & make a venv
    > cd gama
    /gama> conda create -n gama python=3.10 -y
    # install all the dependencies
    /gama> conda activate gama
    (gama) /gama> pip install -r requirements.txt
...
| Libraries Used   | Why?                                                                                                                                                                                                      |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fast API         | We used fast api. Because it is very light weight and also new!, we also went with a api approach so that other developers can use our api to integrate it in thier own applications                   |
